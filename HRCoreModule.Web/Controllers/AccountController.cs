...
using HRCoreModule.Sessions;
using HRCoreModule.Web.Controllers.Results;
using HRCoreModule.Web.Models;
using HRCoreModule.Web.Models.Account;
...
{
    public class AccountController : HRCoreModuleControllerBase
    {
